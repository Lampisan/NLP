...
\begin{itemize}[topsep=0mm, partopsep=0mm, noitemsep, leftmargin=*, label=\faSquareO]
	...
	\item Feature space spawned by terms over documents represented as a matrix
...
\begin{itemize}[topsep=0mm, partopsep=0mm, noitemsep, leftmargin=*, label=\faSquareO]
	\item Words are influenced by their surrounding words in context
	\item The sentiment influences the word order in conjunctions
	\item Average sentence length depends on the author's specific writing style
...
\begin{itemize}[topsep=0mm, partopsep=0mm, noitemsep, leftmargin=*, label=\faSquareO]
	...
	\item Deep learning is considered the state of the art for many NLP tasks
\end{itemize}
