...
\begin{enumerate}
\item  
	A machine learning approach seems to be the best fit. Probably some kind of deep learning like BERT (maybe we find a pretrained BERT-model that is trained on technical reports or similar). 
\item 
	Evaluation often struggles as there is often no ground truth.
\end{enumerate}
